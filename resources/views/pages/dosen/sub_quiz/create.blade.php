            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('dosen.sub_quiz.store', ['id_quiz' => $quiz->id]) }}" method="POST"
                            ...
                            <div class="col-lg-12">
                                ...
                                <!-- TinyMCE Editor -->
                                <textarea class="tinymce-editor" id="pertanyaan" name="pertanyaan">{{ old('pertanyaan') }}</textarea>

                            </div>
                            <div class="col-lg-12">
                                <label for="content" class="form-label">Jawaban A</label>
                                <textarea class="tinymce-editor" id="jawaban_a" name="jawaban_a">{{ old('jawaban_a') }}</textarea>

                            </div>
                            <div class="col-lg-12">
                                <label for="content" class="form-label">Jawaban B</label>
                                <textarea class="tinymce-editor" id="jawaban_b" name="jawaban_b">{{ old('jawaban_b') }}</textarea>

                            </div>
                            <div class="col-lg-12">
                                <label for="content" class="form-label">Jawaban C</label>
                                <textarea class="tinymce-editor" id="jawaban_c" name="jawaban_c">{{ old('jawaban_c') }}</textarea>

                            </div>
                            <div class="col-lg-12">
                                <label for="content" class="form-label">Jawaban D</label>
                                <textarea class="tinymce-editor" id="jawaban_d" name="jawaban_d">{{ old('jawaban_d') }}</textarea>
                            </div>
                            <div class="col-lg-12">
                                <label for="content" class="form-label">Jawaban E</label>
                                <textarea class="tinymce-editor" id="jawaban_e" name="jawaban_e">{{ old('jawaban_e') }}</textarea>
                            </div>
                            <div class="col-md-12">
                                ...
                                <select class="form-select" id="kunci_jawaban" name="kunci_jawaban"
                                    ...
                                    <option value="e" {{ old('kunci_jawaban') == 'c' ? 'selected' : '' }}>E
                                    </option>
                                </select>
                            </div>
