                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.berita.store') }}" class="row g-3 needs-validation" method="POST"
                            ...
                            <div class="col-md-12">
                                <label for="deskripsi" class="form-label">Deskripsi <small class="text-danger">*</small>
                                    <small>anda bisa memasukkan 20-50 kata paling pertama pada sajian
                                        content</small></label>
                                <textarea cols="3" rows="3" name="deskripsi" class="form-control" id="judul" value="{{ old('judul') }}"
                                    required></textarea>
                                @error('deskripsi')
                                    <small class="mt-0 text-danger" style="font-size: 12px">{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-lg-12">
                                ...
                                <!-- TinyMCE Editor -->
                                <textarea class="tinymce-editor" id="content" name="content" required>{{ old('content') }}</textarea><!-- End TinyMCE Editor -->
